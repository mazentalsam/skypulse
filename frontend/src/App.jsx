...
function AppContent() {
  ...
  const S = 40;
  const W = { position: 'relative', zIndex: 1, maxWidth: 1320, margin: '0 auto', padding: '0 32px' };
...
const gBtn = { display: 'inline-flex', alignItems: 'center', gap: 8, padding: '8px 14px', borderRadius: 7, fontSize: 13, fontWeight: 500, color: 'var(--text)', border: '1px solid var(--border-strong)', textDecoration: 'none' };
const kbd = { padding: '2px 6px', border: '1px solid var(--border-strong)', borderRadius: 4, fontSize: 11 };
