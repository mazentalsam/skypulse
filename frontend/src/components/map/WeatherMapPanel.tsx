...
export default function WeatherMapPanel() {
  ...
  const embedUrl = `https://maps.google.com/maps?q=${location.lat},${location.lon}&z=12&output=embed`;
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr' }}>
        <div style={{ height: 300 }}>
          <MapContainer center={center} zoom={9} style={{ height: '100%', width: '100%' }} scrollWheelZoom={false} zoomControl={true}>
            ...
            <TileLayer key={activeLayer} url={`https://tile.openweathermap.org/map/${activeLayer}/{z}/{x}/{y}.png?appid=${import.meta.env.VITE_OWM_TILE_KEY || ''}`} opacity={0.6} />
